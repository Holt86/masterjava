...
public abstract class UserDao implements AbstractDao {
    ...
    @SqlUpdate("INSERT INTO users (full_name, email, flag, city_name) VALUES (:fullName, :email, CAST(:flag AS USER_FLAG), :cityName) ")
    @GetGeneratedKeys
    abstract int insertGeneratedId(@BindBean User user);

    @SqlUpdate("INSERT INTO users (id, full_name, email, flag, city_name) VALUES (:id, :fullName, :email, CAST(:flag AS USER_FLAG), :cityName) ")
    ...
    @SqlBatch("INSERT INTO users (id, full_name, email, flag, city_name) VALUES (:id, :fullName, :email, CAST(:flag AS USER_FLAG), :cityName)" +
